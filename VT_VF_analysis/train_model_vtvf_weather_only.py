...
def load_processed_data():
    ...
    try:
        ...
        df['hospitalization_count'] = df['people_vtvf']  # VT・VFの入院人数
        return df
...
def prepare_data_for_training(df, train_dates, test_dates):
    ...
    # 特徴量とターゲットを分離
    exclude_cols = ['hospitalization_date', 'target', 'season', 'prefecture_name', 'date', 'hospitalization_count', 'people_vtvf', 'people_weather']
