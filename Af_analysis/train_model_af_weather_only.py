...
def load_processed_data():
    ...
    # Afデータを正しく設定
    df['hospitalization_count'] = df['people_af']
...
def prepare_data_for_training(df, train_dates, test_dates):
    ...
    # 特徴量とターゲットを分離
    exclude_cols = ['hospitalization_date', 'target', 'season', 'prefecture_name', 'date', 'hospitalization_count', 'people_af', 'people_weather']
...
def main():
    ...
    try:
        ...
        print("⚠️ 気象情報のみを使用したAfモデルです（入院人数情報は除外）")
